---
name: ui-ux-pro-max
description: UI/UX design intelligence for GPT-style assistants with searchable design data
---
# UI/UX Pro Max - GPT Assistant Guide

Repo-local UI/UX design intelligence for GPT-style assistants. Use this when designing, reviewing, or improving frontend UI, UX, accessibility, responsive layouts, dashboards, landing pages, design systems, color systems, typography, charts, and interaction states.
...
- **Stack**: use the current project stack. In this repo, prefer Next.js, React, TailwindCSS, and shadcn-style component guidance when applicable.
...
| Stack | Focus |
|-------|-------|
| `nextjs` | Routing, rendering, performance, app structure |
| `react` | Components, state, rendering, performance |
| `html-tailwind` | Tailwind layout, spacing, responsive utilities |
| `shadcn` | Component composition, accessibility, theming |
...
```bash
python3 skills/ui-ux-pro-max/scripts/search.py "dashboard layout responsive" --stack nextjs
```
