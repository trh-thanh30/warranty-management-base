...
import { DeactivateDealerDialog } from "./components/deactivate-dealer-dialog";
import { DealersDirectoryCard } from "./components/dealers-directory-card";
import { useDealersDirectory } from "./hooks/use-dealers-directory";

export function DealersView() {
  const t = useTranslations("Dealers");
  const directory = useDealersDirectory();
    ...
    <PermissionGuard permissions={[PERMISSIONS.DEALER_VIEW]}>
      <div className="space-y-6">
        ...
        <DealersDirectoryCard
          ...
          onRetry={() => {
            void directory.dealersQuery.refetch();
          }}
        ...
        <DeactivateDealerDialog
          dealer={directory.dealerToDeactivate}
          ...
          open={Boolean(directory.dealerToDeactivate)}
        />
        ...
        <ExcelImportDialog
          ...
          onSubmit={(file) => {
            void directory.importDealerFile(file);
          }}
