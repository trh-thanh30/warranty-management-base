...
const STATUS_BADGE_CLASS_NAMES = {
  ARCHIVED:
    "border-slate-200 bg-slate-100 text-slate-700 hover:bg-slate-100 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-300",
  IN_PROGRESS:
  ...
  NEW: "border-red-200 bg-red-50 text-red-700 hover:bg-red-50 dark:border-red-900/60 dark:bg-red-950/40 dark:text-red-300",
  RESOLVED:
