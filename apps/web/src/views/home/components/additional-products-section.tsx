    ...
    <section className="w-full bg-surface-muted py-16 lg:py-24">
      <Container className="space-y-10">
        ...
        >
          ...
          <h2 className="text-2xl font-semibold uppercase tracking-wide text-deep-black sm:text-4xl lg:text-5xl leading-snug">
            {t("title")}
          </h2>
          <p className="mx-auto max-w-2xl text-base text-stone-gray sm:text-lg text-justify text-pretty leading-relaxed">
            {t("description")}
          </p>
        ...
        <div className="relative">
          <div
            className="overflow-hidden cursor-grab active:cursor-grabbing rounded-md"
            ref={emblaRef}
          >
            <div className="-ml-6 flex">
              {additionalProductCategories.map((category) => {
                ...
                return (
                  ...
                  >
                    <article className="group relative flex h-full flex-col justify-between overflow-hidden rounded-md border border-border-gray bg-white shadow-md transition-all duration-300 hover:-translate-y-1.5 hover:border-premium-red hover:shadow-xl">
                      <div>
                        <div className="relative aspect-[16/10] w-full overflow-hidden bg-deep-black">
                          ...
                          <div className="absolute left-4 top-4 flex items-center gap-2 rounded-md border border-white/15 bg-deep-black/80 px-3.5 py-2 text-white shadow-md backdrop-blur-xs transition-colors duration-300 group-hover:bg-premium-red">
                        ...
                        <div className="space-y-3 p-6">
                          <h3 className="text-xl font-semibold uppercase tracking-wide text-deep-black transition-colors group-hover:text-premium-red">
                      ...
                      <div className="p-6 pt-0">
                        <Link
                          ...
                          className="flex w-full items-center justify-between rounded-md border border-border-gray bg-surface-muted px-4 py-3 text-xs font-semibold uppercase tracking-wider text-deep-black transition-all group-hover:border-premium-red group-hover:bg-premium-red group-hover:text-white"
                        >
        ...
        <div className="pt-4 text-center">
          <Link
            href={APP_ROUTES.products}
            className="inline-flex cursor-pointer items-center gap-2.5 rounded-md bg-premium-red sm:bg-deep-black sm:hover:bg-premium-red active:scale-95 px-8 py-4 text-xs font-semibold uppercase tracking-wider text-white shadow-xl transition-all duration-300 hover:shadow-2xl sm:text-sm"
          >
